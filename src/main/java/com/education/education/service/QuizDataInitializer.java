...
public class QuizDataInitializer implements CommandLineRunner {
    ...
    private void initializeAptitudeQuiz() throws Exception {
        ...
        questions.add(createQuestion(1, "mathematical", "If a train travels at 60 km/h for 2 hours, how far does it travel?", 
        ...
        questions.add(createQuestion(6, "verbal", "Which sentence is grammatically correct?", 
            new String[]{"He don't like it", "He doesn't likes it", "He doesn't like it", "He not like it"}, "C", 2));
        
        // Analytical Questions
        questions.add(createQuestion(7, "analytical", "What comes next in the series: 2, 6, 18, 54, ?", 
            new String[]{"162", "108", "216", "150"}, "A", 3));
            
        questions.add(createQuestion(8, "analytical", "If all roses are flowers and some flowers are red, which statement is definitely true?", 
            new String[]{"All roses are red", "Some roses are red", "All flowers are roses", "Some roses may be red"}, "D", 3));
        ...
        questions.add(createQuestion(12, "technical", "In a computer, what does CPU stand for?", 
            new String[]{"Central Processing Unit", "Computer Personal Unit", "Central Program Unit", "Control Processing Unit"}, "A", 2));
    ...
    private void initializeInterestQuiz() throws Exception {
        ...
        questions.add(createQuestion(1, "analytical", "Which activity interests you most?", 
            new String[]{"Solving math problems", "Reading novels", "Conducting experiments", "Managing a business"}, "C", 3));
            
        questions.add(createQuestion(2, "verbal", "What type of subjects do you enjoy?", 
            new String[]{"Languages and literature", "Mathematics and physics", "History and social studies", "Economics and business"}, "A", 3));
            
        questions.add(createQuestion(3, "technical", "What career sounds most appealing?", 
            new String[]{"Doctor/Engineer", "Teacher/Writer", "Lawyer/Social worker", "Businessman/Accountant"}, "A", 3));
            
        questions.add(createQuestion(4, "analytical", "How do you prefer to solve problems?", 
            new String[]{"Using logical reasoning", "Through research and reading", "By experimenting", "By discussing with others"}, "A", 3));
            
        questions.add(createQuestion(5, "mathematical", "Which statement describes you best?", 
            new String[]{"I love working with numbers", "I enjoy creative writing", "I like helping people", "I'm interested in technology"}, "A", 3));
            
        questions.add(createQuestion(6, "verbal", "What type of learning environment do you prefer?", 
            new String[]{"Laboratory experiments", "Library research", "Group discussions", "Practical workshops"}, "B", 2));
            
        questions.add(createQuestion(7, "technical", "Which subject combination interests you most?", 
            new String[]{"Physics, Chemistry, Math", "English, History, Geography", "Math, Economics, Accounts", "Biology, Chemistry, Physics"}, "A", 3));
            
        questions.add(createQuestion(8, "analytical", "What motivates you most in studies?", 
            new String[]{"Understanding how things work", "Expressing ideas creatively", "Solving real-world problems", "Building successful ventures"}, "A", 3));
