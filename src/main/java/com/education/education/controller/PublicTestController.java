    ...
    private QuizAnalysis analyzeQuizResults(List<String> answers) {
        ...
        for (int i = 0; i < Math.min(answers.size(), correctAnswers.size()); i++) {
            if (answers.get(i).equals(correctAnswers.get(i))) {
                ...
                if (i < 4)
                    strengths.add("Mathematical reasoning");
                else if (i < 8)
                    strengths.add("Scientific thinking");
                else
                    strengths.add("Analytical skills");
            } else {
                if (i < 4)
                    weaknesses.add("Mathematical concepts");
                else if (i < 8)
                    weaknesses.add("Scientific understanding");
                else
                    weaknesses.add("Logical reasoning");
            }
        }
